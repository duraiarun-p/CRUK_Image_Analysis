...
spectral_dimension_ind=1;
temporal_dimension_ind=2;
spatial_dimension_ind=[3,4];
n_spectrum = siz(spectral_dimension_ind);
...
%         bins_array_3 = permute(bins_array_3, [temporal_dimension_ind spectral_dimension_ind spatial_dimension_ind(1) spatial_dimension_ind(2)]); 
