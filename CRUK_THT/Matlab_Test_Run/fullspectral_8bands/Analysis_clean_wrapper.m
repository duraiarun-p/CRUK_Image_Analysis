...
tic;
[allIntensityImages1,lifetimeImageData1,lifetimeAlphaData1]=Analysis_LMfitting(filePath,currentFolder,[10,14]);
[allIntensityImages2,lifetimeImageData2,lifetimeAlphaData2]=Analysis_EXPfitting(filePath,currentFolder,[10,14]);
[allIntensityImages3,lifetimeImageData3,lifetimeAlphaData3]=Analysis_EXPfitting(filePath,currentFolder,[1,14]);

[SSIM_AB_C1,SSIM_FB_C1]=SSIM_Analysis(allIntensityImages1,lifetimeAlphaData1,lifetimeImageData1);
[SSIM_AB_C2,SSIM_FB_C2]=SSIM_Analysis(allIntensityImages2,lifetimeAlphaData2,lifetimeImageData2);
[SSIM_AB_C3,SSIM_FB_C3]=SSIM_Analysis(allIntensityImages3,lifetimeAlphaData3,lifetimeImageData3);
stop_time=toc/60;
...
function [allIntensityImages,lifetimeImageData,lifetimeAlphaData]=Analysis_LMfitting(filePath,currentFolder,binToFit)
% Temporal resolution
n_bins = 16;
