...
% matfilename='feat_23.mat';
matfilename='feat_15.mat';
...
% train_data=[feat_matrix_I,feat_matrix_S];
% train_label=[class_I;class_S];

% train_data=[feat_matrix_T,feat_matrix_I,feat_matrix_S];
% train_label=[class_T;class_I;class_S];

train_data=feat_matrix_O;
train_label=class_O;
...
for base_i = 2:length(base_dir_all)
    ...
    % train_data=[train_data,feat_matrix_I,feat_matrix_S];
    % train_label=[train_label;class_I;class_S];

    % train_data=[train_data,feat_matrix_T,feat_matrix_I,feat_matrix_S];
    % train_label=[train_label;class_T;class_I;class_S];

    train_data=[train_data,feat_matrix_O];
    train_label=[train_label;class_O];
end
